...
namespace SistemaEduEscola.Controllers
{
    public class UnidadesController : Controller
    {
        ...
        public UnidadesController(TabelaEscola context)
        {
            _context = context;
        }
        ...
        public ActionResult Index(string Pesquisar = "")
        {
            ...
            if (!string.IsNullOrEmpty(Pesquisar))
                unidades = unidades.Where(c => c.NomeUnidade.Contains(Pesquisar));
            unidades = unidades.OrderBy(c => c.NomeUnidade);
        ...
        {
            //Unidade emp = new Unidade();
            return View();
            //return PartialView("Index", emp);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeUnidade,Enderoco,QtdAlunos,QtdTurmas")] Unidade unidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeUnidade,Enderoco,QtdAlunos,QtdTurmas")] Unidade unidade)
        {
            if (id != unidade.Id)
            {
                return NotFound();
